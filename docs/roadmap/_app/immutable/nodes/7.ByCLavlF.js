import{C as e,H as t,T as n,W as r,nt as i,rt as a,v as o}from"../chunks/CubxcVna.js";import"../chunks/xihTtKlq.js";import"../chunks/CamEucdS.js";var{title:s,description:c}={title:`LIVING_APPLICATION_MAP`,description:`Repository reference documentation.`},l=n(`<h1>Living Application Map</h1> <h2>Product direction</h2> <p>Cassor should grow into a living product memory for an application: a
...
explain how it arrived there.</p>`,1);function u(n){var s=l(),c=r(t(s),20);o(c,()=>`<code class="language-text">Application
...
Feature dossier
  ...
  &#96;- relationships to other features and decisions</code>`,!0),a(c);var u=r(c,40);o(u,()=>`<code class="language-text">Discover existing capability
  -&gt; document current state
  -&gt; identify a gap or desired change
  -&gt; research and define it
  -&gt; approve a delivery plan
  -&gt; implement and verify
  -&gt; refresh the feature&#39;s current-state summary</code>`,!0),a(u),i(2),e(n,s)}export{u as component};