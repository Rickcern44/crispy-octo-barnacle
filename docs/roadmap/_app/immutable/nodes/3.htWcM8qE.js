import{G as e,K as t,M as n,P as r,b as i,p as a,v as o}from"../chunks/B9N-qlPM.js";import"../chunks/xihTtKlq.js";import"../chunks/CFSP7uxU.js";var{title:s,description:c}={title:`LIVING_APPLICATION_MAP`,description:`Repository reference documentation.`},l=i(`<h1>Living Application Map</h1> <h2>Product direction</h2> <p>Cassor should grow into a living product memory for an application: a
...
and agent contributions coherent.</p> <h2>Intended lifecycle</h2> <pre class="language-text"></pre> <p>Refreshing current truth after delivery is essential: Cassor should describe
the application as it is now, while preserving the decisions and evidence that
explain how it arrived there.</p>`,1);function u(i){var s=l(),c=r(n(s),20);a(c,()=>`<code class="language-text">Application
...
Feature dossier
  ...
  &#96;- relationships to other features and decisions</code>`,!0),t(c);var u=r(c,32);a(u,()=>`<code class="language-text">Discover existing capability
  -&gt; document current state
  -&gt; identify a gap or desired change
  -&gt; research and define it
  -&gt; approve a delivery plan
  -&gt; implement and verify
  -&gt; refresh the feature&#39;s current-state summary</code>`,!0),t(u),e(2),o(i,s)}export{u as component};